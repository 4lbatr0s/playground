...
public class NGRKPSPublicSoap
{
    ...
    public NGRKPSPublicSoap(){}

    public NGRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NGRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NGRExtendedSoapSerializationEnvelope envelope= new NGRExtendedSoapSerializationEnvelope(NGRExtendedSoapSerializationEnvelope.VER11);
